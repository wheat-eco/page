    ...
    content: `
      <div class="space-y-8">
        <section class="space-y-4">
          ...
          <p class="text-gray-300">We're not just another token – we're a utility coin with a clear mission and a commitment to longevity. Here's what we've come to do:</p>
        </section>
